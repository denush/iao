<template>
	...
	<div class='temp-table-current'>
		...
		<template v-else>
			...
			<EditRowModal
				v-model:visible='editRowModalOpen'
...
<script>
	...
	import TableToolbar from './CurrentTempTable__toolbar';
	import TableComponent from './CurrentTempTable__table';
	import EditRowModal from './CurrentTempTable__editRowModal';
	import QuickEditModal from './CurrentTempTable__quickEditModal';
