	...
	<table class='temp-table'>
		<thead class='temp-table__head'>
			<tr class='temp-table__head-row'>
				...
				<th v-for='column in tempTableColumnList' class='temp-table__head-column' :key='column.id'>
			...
			<tr>
				<th class='temp-table__head-column temp-table__id-head-column'></th>
				<th v-for='column in tempTableColumnList' class='temp-table__head-column' :key='column.id'>{{ column.field_num }}</th>
			</tr>
		</thead>
...
<script>
	...
	export default {
		...
		methods: {
			...
			...mapMutations('tempTablesForestries', [
				'setCurrentPage'
			]),

			...mapActions('tempTablesForestries', [
				'getTempTable'
			])
		}
