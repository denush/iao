...
const GET_TEMP_TABLE_TEMPLATE = ROOT_API + 'get_tmp_table_template_forestries.php';
const GET_TEMP_TABLE = ROOT_API + 'get_tmp_table_forestries.php';
const GET_TEMP_TABLE_ROW_COUNT = ROOT_API + 'get_tmp_table_row_count_forestries.php';
const VERIFY_TEMP_TABLE = ROOT_API + 'verify_temp_table_forestries.php';
...
export default {
	...
	actions: {
      ...
      console.log('table_id: ', state.tempTableId);
