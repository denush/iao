...
if (!empty($_SESSION['registry_auth']) and $_SESSION['registry_auth']) {
	...
	$query = "SELECT * FROM czl_reg_user_registry('${user_login}', '${user_fio}', ${user_is_admin}, '${regions_view}', '${regions_change}', '${regions_delete}', '${regions_extract}', ${location}, ${decree}, ${role_decree})";
